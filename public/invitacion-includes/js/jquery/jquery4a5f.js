/*! jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license | WordPress 2019-05-16 */ !(function (a, b) {
	...
	n.extend({
			...
			inArray: function (a, b, c) {
				...
				if (b) {
					...
					for (
						d = b.length, c = c ? (c < 0 ? Math.max(0, d + c) : c) : 0; c < d; c++
					)
			...
			(i = ea.select = function (a, b, e, f) {
				...
				return (
					(n || h(a, o))(
						f,
						b, !p,
						e, !b || (_.test(a) && na(b.parentNode)) || b
					),
					e
				);
			}),
		...
		closest: function (a, b) {
			for (
				var c,
					...
					e = this.length,
					f = [],
					g = w.test(a) || "string" != typeof a ? n(a, b || this.context) : 0; d < e; d++
			)
	...
	function ia(a, b, c, d, e) {
		for (
			var f, g, h, i, j, k, m, o = a.length, p = ba(b), q = [], r = 0; r < o; r++
		)
			if ((g = a[r]) || 0 === g)
			...
			if (
				(!l.leadingWhitespace &&
					_.test(g) &&
					q.push(b.createTextNode(_.exec(g)[0])), !l.tbody)
			) {
				(g =
					"table" !== j || ga.test(g) ?
					"<table>" !== m[1] || ga.test(g) ?
	...
	(n.event = {
		...
		trigger: function (b, c, e, f) {
			...
			if (
				...
				if (!f && !l.noBubble && !n.isWindow(e)) {
					for (
						j = l.delegateType || q, ma.test(j + q) || (i = i.parentNode); i; i = i.parentNode
					)
						p.push(i), (m = i);
					m === (e.ownerDocument || d) &&
		...
		dispatch: function (a) {
			...
			if (
				((i[0] = a),
					(a.delegateTarget = this), !k.preDispatch || !1 !== k.preDispatch.call(this, a))
			) {
	...
	n.each({
		...
		n.fn.extend({
			...
			off: function (a, b, c) {
				...
				return (
					(!1 !== b && "function" != typeof b) || ((c = b), (b = void 0)), !1 === c && (c = pa),
					this.each(function () {
	...
	n.extend({
			...
			ajax: function (b, c) {
				...
				i && 0 == n.active++ && n.event.trigger("ajaxStart"),
					...
					l.hasContent ||
					(l.data &&
						((f = l.url += (Eb.test(f) ? "&" : "?") + l.data), delete l.data), !1 === l.cache &&
						(l.url = Hb.test(f) ?
							f.replace(Hb, "$1_=" + Db++) :
							f + (Eb.test(f) ? "&" : "?") + "_=" + Db++)),
					l.ifModified &&
