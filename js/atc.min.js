		...
		toogle: function (e, t) {
			...
			if (n = $d(a = e.id)) {
				...
				if ("outlook" == o || "google" == o || "yahoo" == o || "hotmail" == o || "outlookcom" == o || "appleical" == o || "apple" == o || "facebook" == o) "click" == t.type && (addeventatc.click({
					...
					if (addeventatc.getlicense(v) || (c += '<em class="copyx"><em class="brx"></em><em class="frs"><a href="https://www.addevent.com" title="" tabindex="-1" id="' + a + '-home">AddEvent.com</a></em></em>'), !$d(a + "-drop")) {
			...
			if (t = $d(e.button)) {
				if ("home" == e.service) n = "https://www.addevent.com";
					...
					a = addeventatc.getburl({
						id: e.button,
						facebook: !1
					}), n = "https://www.addevent.com/create/?service=" + e.service + a + "&reference=" + d, "outlook" != e.service && "appleical" != e.service || (o = !1, addeventatc.usewebcal() && (n = "webcal://www.addevent.com/create/?uwc=on&service=" + e.service + a + "&reference=" + d));
